...
const ASSETS = ['./', './index.html', './theme.js?v=33', './config.js?v=33', './app.css?v=33', './app.js?v=33', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
