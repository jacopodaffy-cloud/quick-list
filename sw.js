...
const ASSETS = ['./', './index.html', './theme.js?v=59', './config.js?v=59', './i18n.js?v=59', './app.css?v=59', './app.js?v=59', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
