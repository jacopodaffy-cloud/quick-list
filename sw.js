...
const ASSETS = ['./', './index.html', './theme.js?v=46', './config.js?v=46', './app.css?v=46', './app.js?v=46', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
