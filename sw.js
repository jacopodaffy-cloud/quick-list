...
const ASSETS = ['./', './index.html', './theme.js?v=18', './config.js?v=18', './app.css?v=18', './app.js?v=18', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
