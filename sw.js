...
const ASSETS = ['./', './index.html', './theme.js?v=47', './config.js?v=47', './app.css?v=47', './app.js?v=47', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
