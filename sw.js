...
const ASSETS = ['./', './index.html', './theme.js?v=41', './config.js?v=41', './app.css?v=41', './app.js?v=41', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
