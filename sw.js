...
const ASSETS = ['./', './index.html', './theme.js?v=19', './config.js?v=19', './app.css?v=19', './app.js?v=19', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
