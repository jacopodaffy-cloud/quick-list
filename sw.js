...
const ASSETS = ['./', './index.html', './theme.js?v=34', './config.js?v=34', './app.css?v=34', './app.js?v=34', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
