...
const ASSETS = ['./', './index.html', './theme.js?v=58', './config.js?v=58', './i18n.js?v=58', './app.css?v=58', './app.js?v=58', './manifest.webmanifest', './icon.svg', './icon-maskable.svg', './icon-192.png', './icon-512.png'];
