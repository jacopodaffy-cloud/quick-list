...
This release: **assets `?v=39`, sw cache `quicklist-v40`, Android `versionCode 40`.**
...
- **Bump every release**: `versionCode` (→ **40**), asset `?v=` (→ 39), sw cache (→ `quicklist-v40`). Play rejects a re‑used `versionCode`.
